...
import 'core/shared_service/location.dart' as _i10;
import 'core/shared_service/shared_firebase_analytics.dart' as _i8;
import 'core/shared_service/third_party_service.dart' as _i13;
import 'core/shared_service/user_service.dart' as _i11;
import 'modules/mod-auth/view_model/auth_view_model.dart' as _i12;
import 'modules/profile/profiel_view_model.dart' as _i6;
import 'modules/restaurants_search/restaurants_map_view_model.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.RestaurantsSearchViewModel>(() =>
      _i7.RestaurantsSearchViewModel(
          get<_i3.ApiRepository>(), get<_i5.DialogService>()));
  gh.lazySingleton<_i8.SharedFirebaseAnalytics>(
      () => _i8.SharedFirebaseAnalytics());
  gh.lazySingleton<_i5.SnackbarService>(
      () => thirdPartyServicesModule.snackBarService);
  gh.factory<_i9.SplashViewModel>(
      () => _i9.SplashViewModel(get<_i4.AuthService>()));
  gh.factory<_i10.UserLocation>(() => _i10.UserLocation());
  gh.factory<_i11.UserService>(() => _i11.UserService());
  gh.factory<_i12.AuthViewModel>(() =>
      _i12.AuthViewModel(get<_i4.AuthService>(), get<_i5.DialogService>()));
  return get;
}
